...
const Footer = () => {
  return (
    <div>
      <div className="bg-gray-900 text-white  mt-[6rem] px-6 py-4 flex flex-col gap-8 sm:flex-row sm:px-8 sm:py-4 justify-between text-sm rounded-tl-2xl rounded-tr-2xl flex-wrap md:items-center">
        <div>
          <img src="QuickBite.png" alt="" className="w-28 mb-1" />
          <p >
        ...
        <div>
            <p className="text-lg font-medium mb-1">User Links</p>
            <ul>
                <li>Home</li>
                <li>Shop</li>
                <li>Menu</li>
